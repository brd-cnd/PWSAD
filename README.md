...
- Création de l'arborescence primaire de l'entreprise (structure initiale). Ce script à n'exécuter qu'une fois, mais s'il est exécuté une seconde fois, une vérification de la présence des unités d'organisation spécifiq)
