...
#. C:\Users\S.M1502QA\Documents\BTS\AP\AP2-M1\PWSAD\CSTES\constsPathsModules.ps1
#. C:\Users\S.M1502QA\Documents\BTS\AP\AP2-M1\PWSAD\CSTES\constsPathsOU.ps1
...
[string[]]$nomUnites = @("ETP Chasseneuil","Administration","Adhérents","Clients entreprises","Groupes","Groupes globaux","Groupes domaine local")
